...
|:-:|:-----:|:---------:|:----------:|
|1|[Two Sum](https://oj.leetcode.com/problems/two-sum/)|[Python](./src/1.two-sum.py) |Medium|
|2|[Add Two Numbers](https://oj.leetcode.com/problems/add-two-numbers/)|[Python](./src/2.add-two-numbers.py) |Medium|
|3|[Longest Substring Without Repeating Characters](https://oj.leetcode.com/problems/longest-substring-without-repeating-characters/)|[Python](./src/3.longest-substring-without-repeating-characters.py)|Medium|
|4|[Median of Two Sorted Arrays](https://oj.leetcode.com/problems/median-of-two-sorted-arrays/)| [Python](./src/4.median-of-two-sorted-arrays.py) |Hard|
|5|[Longest Palindromic Substring](https://oj.leetcode.com/problems/longest-palindromic-substring/)|[Python](./src/5.longest-palindromic-substring.py) |Medium|
|6|[ZigZag Conversion](https://oj.leetcode.com/problems/zigzag-conversion/)|[Python](./src/6.zigzag-conversion.py)|Easy|
|7|[Reverse Integer](https://oj.leetcode.com/problems/reverse-integer/)|[Python](./src/7.reverse-integer.py)|Easy|
|8|[String to Integer (atoi)](https://oj.leetcode.com/problems/string-to-integer-atoi/)|[Python](./src/8.string-to-integer-atoi.py) |Easy|
